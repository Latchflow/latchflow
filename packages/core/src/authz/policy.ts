...
export const POLICY: Record<RouteSignature, PolicyEntry> = {
  ...
  "GET /system/config": { action: "read", resource: "system_config" },
  "PUT /system/config": { action: "update", resource: "system_config" },
  "GET /system/config/:key": { action: "read", resource: "system_config" },
  "PUT /system/config/:key": { action: "update", resource: "system_config" },
  "DELETE /system/config/:key": { action: "delete", resource: "system_config" },
  "POST /system/config/test": { action: "update", resource: "system_config" },
